...
javac -classpath javaparser-symbol-solver-core-3.6.23.jar src/no/iterate/Testable.java src/no/iterate/TestResults.java src/no/iterate/Tests.java src/no/iterate/CodeCamp.java -d out/production/cc18/ && \
